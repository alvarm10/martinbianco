...
var nombreUnidad = "HTML5 Template - Title of the unit";   			//Título de la Unidad
var lineaNegocio = "academico";					//grupo, customizado y academico 	
var navegacion = "restringida";					//libre, restringida o semirestringida (solo actividades)
var idioma = "ES";								//nunca, siempre, respCorrectas y respIncorrectas
var mostrarScrollUp = "si";						//Si se quiere o no mostrar el boton de "scroll-up" (subida rapida). "si" o "no"
...
var indice = [
	...
	},
	{
		"pag": 29,
		"tema": "Académico",
		"subtema": "Elementos estáticos",
	},
	{
		"pag": 30,
		"tema": "Académico",
		"subtema": "Elementos dinámicos",
	},
	{
		"pag": 31,
		"tema": "Activities",
...
if (idioma=="EN"){
	...
	tabladinamica1ayuda = "Click on a row and a column to show the information"
	tabladinamica2ayuda = "Click on each row and to show the information"
	...
	//HERRAMIENTAS
	$("#ayuda").load("../assets/tools/EN/help/help.html");
	$("#docs").load("../assets/tools/EN/docs/docs.html");
	$("#glossary").load("../assets/tools/EN/glossary/glossary.html");
}
...
if (idioma=="ES"){
	...
	tabladinamica1ayuda = "Pulsa en una fila y en una columna para desplegar la información."
	tabladinamica2ayuda = "Pulsa en cada fila para desplegar la información."
	//MENSAJE PARA QUE PULSE EN EL AUDIO PRINCIPAL DE LA DIAPOSITIVA
	...
	//HERRAMIENTAS
	$("#ayuda").load("../assets/tools/ES/help/help.html");
	$("#docs").load("../assets/tools/ES/docs/docs.html");
	$("#glossary").load("../assets/tools/ES/glossary/glossary.html");
}
...
if (idioma=="FR"){
	...
	tabladinamica1ayuda = "Cliquez sur une ligne et une colonne pour afficher les informations"
	tabladinamica2ayuda = "Cliquez sur chaque ligne et pour afficher les informations"
	//MENSAJE PARA QUE PULSE EN EL AUDIO PRINCIPAL DE LA DIAPOSITIVA
	...
	//HERRAMIENTAS
	$("#ayuda").load("../assets/tools/FR/help/help.html");
	$("#docs").load("../assets/tools/FR/docs/docs.html");
	$("#glossary").load("../assets/tools/FR/glossary/glossary.html");
}
/*==================================================================================================== */
/*==================================================================================================== */
/*==================================================================================================== */
