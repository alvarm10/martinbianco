...
function cargarPagina(){
	...
	if (estado=="incomplete" || estado=="not attempted"){
		...
		if (intentosrealizados>=datostest[0].numerointentos){
			...
			$('.test').html('<div id="resultado"><h1>'+pantallaFinalTest[0].mensajefinal+'</h1><span>'+nota+" %"+'</span><p>'+pantallaFinalTest[0].nointentos+'</p></div>');
