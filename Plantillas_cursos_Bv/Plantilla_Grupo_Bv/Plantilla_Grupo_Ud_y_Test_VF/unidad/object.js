...
var pantallaFinalTest =[{
    "mensajefinal":"You have finished the test. Here are your results:", //Aquí introducimos el mensaje de has finalizado el test y tu nota es de...////////////////////////////////////////////////////

    "aprobado":"Congratulations! You have satisfactorily achieved this Unit.", // Se introduce lo que queremos que ponga si el alumno aprueba el test. ////////////////////////////////////////////////////////////////////

    "suspenso":"In order to complete this Unit, you have to obtain 100% of good answers. Take the Final Test again.", // Se introduce lo que queremos que ponga si el alumno suspende el test. ///////////////////////////////////////////////////////////////////////////////

    "nointentos":"Sorry, you can't repeat the test", // Mensaje que aparece cuando al alumno se le acaban los intentos en el test. ////////////////////////////////////////////////////////////////////////
    }
];
...
var de = "of"; //"de": para español, "of": para inglés, "de" para frances, etc
/////////////////////////////////////////////////////

var txtIntento = "Attempt"; //"Intento": para español, "Attempt: para inglés, etc//////////////////////////////////////////////////

var txtPregunta = "Question"; //"Pregunta": para español, "Question": para inglés, "Question": para francés, etc//////////////////////////////////////////////////

var txtTituloTest = "Final Test"; //"Test de Evaluación": para español, "Final Test": para inglés, etc//////////////////////////////////////////////////
